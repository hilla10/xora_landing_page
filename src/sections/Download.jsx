          ...
          <div className='flex items-center'>
              ...
              <ul className='flex flex-wrap items-center gap-6'>
                {links.map(({ id, url, icon }) => (
                  <li
                    ...
                    <a
                      href={url}
                      className='size-22 download_tech-icon_before relative flex items-center justify-center rounded-half bottom-2 border-s3 bg-s1 transition-borderColor duration-500 '>
            ...
            <div className='mb-10 max-md:hidden'>
              <div className='download_preview-before download_preview-after rounded-40 relative w-[955px] border-2 border-s5 p-6 '>
                <div className='relative rounded-3xl bg-s1 px-5 pb-6 pt-14'>
